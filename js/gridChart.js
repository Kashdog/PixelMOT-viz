...
function draw(selector, draw, data, hovered_pixel){
    ...
    if(draw){
        ...
        // Add title to graph
        d3.selectAll(selector).append("text")
        .attr("x", 0)
        .attr("y", -22)
        .attr("fill", "white")  
...
selectors = [".no_noise",".noise1", ".noise2" ]
gradients1 = ["gradients_1.json", "noise1_gradients1.json", "noise2_gradients1.json"]
gradients2 = ["gradients_2.json", "noise1_gradients2.json", "noise2_gradients2.json"]
